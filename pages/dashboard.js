      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-white rounded shadow p-4 space-y-4">
          ...
          <p className="text-gray-800">
            ...
            loin filet mignon pastrami. Beef buffalo jowl, picanha pancetta tail corned beef
        ...
        <div className="bg-white rounded shadow p-4 space-y-4">
          ...
          <p className="text-gray-800">
            ...
            Bresaola ground round bacon beef sirloin leberkas buffalo salami boudin andouille kevin
            strip steak meatloaf ball tip corned beef. Cow spare ribs flank pastrami. Tenderloin
            short loin salami, short ribs shoulder bacon doner pork turducken kielbasa pork loin
            ham. Shankle pancetta short ribs tri-tip landjaeger. Biltong pork loin cow ham hock
            cupim pork short ribs chuck ribeye shankle rump beef.
          </p>
          <p className="text-gray-800">
