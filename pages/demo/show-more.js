  ...
  return (
    <Layout title="Components">
      ...
      <div className="prose-sm">
        ...
        <p>
          Bacon ipsum dolor amet pork belly venison tongue, hamburger short loin spare ribs alcatra
          swine cow kielbasa boudin. Burgdoggen meatloaf drumstick ground round biltong pork.
          Tri-tip pig ground round, tail brisket shankle tongue jerky beef ribs venison tenderloin
          bacon strip steak. Tail biltong pork chop alcatra bresaola pork loin.
        </p>
